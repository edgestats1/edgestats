...
import type { ExpectedGoals, LoadedMasterModel, TeamMatchProfile } from '../types.js';
import { computeAttackIndex, computeDefenceIndex, round } from '../teamRatings.js';
import type { MatchStatProjection } from '../statProjectionModel.js';

export interface CalibratedExpectedGoals extends ExpectedGoals {
...
export function calibrateExpectedGoals(
  model: LoadedMasterModel,
  home: TeamMatchProfile,
  away: TeamMatchProfile,
  statProjection: MatchStatProjection,
): CalibratedExpectedGoals {
